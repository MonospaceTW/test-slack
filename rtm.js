...
// Using the defaults for these settings is deprecated.
...
// The client will emit an RTM.AUTHENTICATED event on when
// the connection data is avaiable (before the connection is open)
...
rtm.on(RTM_EVENTS.MESSAGE, (message) => {
    ...
    // (message.subtype && message.subtype === 'bot_message') || (!message.subtype && message.user === appData.selfId) ||
    //
    if ( true) {
